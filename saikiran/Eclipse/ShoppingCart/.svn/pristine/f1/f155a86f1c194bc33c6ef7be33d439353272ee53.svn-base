...
<body>
	<form method="Post" action="LoginAuthentication">
		<table align="center" border="1" cellpadding="5" cellspacing="5" id="id02">
				<tbody>
					<tr>
					...
					<tr>
						...
						<td align="right">Forgot password?<a href="forgotPassword.jsp">Click here</a></td>
					</tr>
					<tr>
						<td align="center" colspan="2">New user <a href="registerPage.jsp">Click here </a></td>
					</tr>
				</tbody>
			</table>
